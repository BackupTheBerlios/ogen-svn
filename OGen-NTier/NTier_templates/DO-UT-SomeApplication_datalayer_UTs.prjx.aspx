...
#endregion
//-----------------------------------------------------------------------------------------
%><Project name="<%=aux_metadata.ApplicationName%>_datalayer_UTs" standardNamespace="<%=aux_metadata.Namespace%>.lib.datalayer.UTs" description="" newfilesearch="None" enableviewstate="True" version="1.1" projecttype="C#">
  <Contents>
  ...
  <Configuration runwithwarnings="True" name="Debug">
    ...
    <Output directory=".\bin\Debug" assembly="<%=aux_metadata.Namespace%>.lib.datalayer.UTs" executeScript="" executeBeforeBuild="" executeAfterBuild="" executeBeforeBuildArguments="" executeAfterBuildArguments="" />
  </Configuration>
  <Configurations active="Debug">
    ...
    <Configuration runwithwarnings="True" name="Release">
      ...
      <Execution commandlineparameters="" consolepause="False" />
      <Output directory=".\bin\Release" assembly="<%=aux_metadata.Namespace%>.lib.datalayer.UTs" executeScript="" executeBeforeBuild="" executeAfterBuild="" executeBeforeBuildArguments="" executeAfterBuildArguments="" />
    </Configuration>
  </Configurations>
</Project>
