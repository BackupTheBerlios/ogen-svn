...
#endregion
//-----------------------------------------------------------------------------------------
%>CREATE PROCEDURE [dbo].[sp0_<%=aux_table.Name%>_delObject_<%=aux_search.Name%>]<%
...
AS<%
	...
	DECLARE @<%=aux_field.Name%> <%=aux_field.DBType_inDB_name%><%=(aux_field.isText) ? " (" + aux_field.Size + ")" : ""%><%
	}%>
