...
#endregion
//-----------------------------------------------------------------------------------------
%>CREATE PROCEDURE `sp0_<%=aux_table.Name%>_Record_open_<%=aux_search.Name%>_page_fullmode`(<%
	...
	IN `<%=aux_field_name%>_search` <%=aux_field.DBType_inDB_name%><%=(aux_field.isText) ? "(" + aux_field.Size + ")" : ""%>, <%
	}%>
	IN `page_` Int,
