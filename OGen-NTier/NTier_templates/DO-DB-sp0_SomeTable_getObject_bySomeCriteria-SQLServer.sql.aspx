...
for (int f = 0; f < _aux_table.Fields.Count; f++) {
	...
	@<%=_aux_field.Name%> <%=_aux_field.DBs[_aux_dbervertype].DBType_inDB_name%><%=(_aux_field.isText) ? " (" + _aux_field.DBs[_aux_dbervertype].Size + ")" : ""%> OUT<%=(f != _aux_table.Fields.Count - 1) ? ", " : ""%><%
}%>
AS
	DECLARE @Exists Bit
	SET @Exists = 0
